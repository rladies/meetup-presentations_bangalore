...
- install the distill package, `remotes::install_github("rstudio/distill")`
...
- install the postcards package. `remotes::install_github("seankross/postcards")`

- Follow Alison Hill's tutorial ["M-F-E-O: postcards + distill"]](https://alison.rbind.io/post/2020-12-22-postcards-distill/). `postcards::create_postcard("about.Rmd")`